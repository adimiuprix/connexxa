...
export default function CategoryPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                setLoading(true);
                setError(false);
                const res = await fetch(`/api/categories/${slug}`, { cache: 'no-store' });
    ...
    const sortedProducts = [...products].sort((a, b) => {
        switch (sort) {
            ...
            case 'nama-asc': return (a.title || '').localeCompare(b.title || '');
            default: return 0;
        }
    });
            ...
            <section className="py-16">
                <div className="max-w-[1920px] mx-auto px-4 lg:px-20">
                    ...
                    <div className="flex items-end justify-between mb-8">
                        <div>
                            {/* Breadcrumb */}
                            <nav className="text-[11px] tracking-wider text-gray-400 uppercase mb-3 flex items-center gap-2">
                    ...
                    {error ? (
                        <div className="py-24 text-center">
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                                Kategori ini tidak ada atau terjadi kesalahan.
                            </p>
                            <Link
                                href="/"
