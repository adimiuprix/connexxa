-- CreateEnum
CREATE TYPE "Availability" AS ENUM ('true', 'false');
...
CREATE TABLE "ProductSize" (
    ...
    "available" "Availability" NOT NULL DEFAULT 'true',
...
-- AddForeignKey
ALTER TABLE "Wishlist" ADD CONSTRAINT "Wishlist_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("uuid") ON DELETE CASCADE ON UPDATE CASCADE;
